...
contract JointSavings {
    // Define two owners of the joint savings account
    ...
    */
    ...
    require(recipient == accountOne || recipient == accountTwo, "You don't own this account!");
        ...
        */
       // Check if the contract has enough balance for the withdrawal
    require(contractBalance >= amount, "Insufficient funds!");
        ...
        */
        // Update the lastToWithdraw if it's not equal to recipient
    ...
    recipient.transfer(amount);
        ...
        // Update the contract state by fetching the new balance
